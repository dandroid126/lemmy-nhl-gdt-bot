...
def create_connection(path_to_db):
    ...
    try:
        ...
        logger.i(TAG, "create_connection(): Connection to SQLite DB successful")
    except Error as e:
        logger.e(TAG, "create_connection(): Error occurred", e)


def create_tables():
    global cursor
    logger.i(TAG, "create_tables(): create_tables: creating tables")
    cursor.execute(
