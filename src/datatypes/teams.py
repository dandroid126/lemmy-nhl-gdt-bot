...
class Teams(Enum):
    ...
    ANA = Team(24, 'ANA', 'Anaheim', 'Ducks', 'https://lemmy.ca/pictrs/image/a278e5aa-6f6f-4cdb-a0dc-03630b03a3a9.png')
    ...
    SJS = Team(28, 'SJS', 'San Jose', 'Sharks', 'https://lemmy.ca/pictrs/image/9efd8b21-3414-4e4f-8be3-559809ec133a.png')
