...
class TestLemmyClient(unittest.TestCase):
    ...
    def test_create_daily_thread(self):
        ...
        result_daily_thread = self.lemmy_client.create_daily_thread(date, "daily thread unit test", f"daily thread unit test body. date: {date}")
        self.assertIsNotNone(result_daily_thread, "result_daily_thread was None")
